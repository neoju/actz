...
<div class="space-y-6 pb-8">
  {#if !plan}
    <div class="flex flex-col items-center justify-center min-h-[40vh] text-center space-y-6">
  ...
  <div class="space-y-2 pt-4">
    ...
    <div data-tour="pt-summary">
      <p
        class={cn("px-4 bg-muted/50 rounded-lg text-sm italic transition-all")}
      >
        " {plan.ptSummary} "
      </p>
    </div>
        ...
        >
          ...
          <Card.Content>
            ...
            {:else}
              ...
              >
                {day.exercises.length} exercises • {day.estimatedTime || "N/A"}
              </p>
            {/if}
          </Card.Content>
        </Card.Root>
