<div class="space-y-6 pb-8">
  ...
  >
    ...
    <p>
      By accessing and using this application ("Service"), you accept and agree
      to be bound by the terms and provision of this agreement. In addition,
      when using these particular services, you shall be subject to any posted
    ...
    <p>
      ...
      materials on the Service, even if we have been notified orally or in
    ...
    <p>
      ...
      materials on its website are accurate, complete, or current. We may make
